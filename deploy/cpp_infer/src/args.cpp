...
// detection related
DEFINE_string(det_model_dir, "PP-OCRv5_mobile_det_infer", "Path of det inference model.");
...
// recognition related
DEFINE_string(rec_model_dir, "PP-OCRv5_mobile_rec_infer", "Path of rec inference model.");
