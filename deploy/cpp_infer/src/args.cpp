...
// common args
DEFINE_bool(use_gpu, true, "Inferring with GPU or CPU.");
...
// detection related
DEFINE_string(det_model_dir, "pplib/PP-OCRv5_mobile_det_infer", "Path of det inference model.");
...
DEFINE_string(cls_model_dir, "pplib/PP-LCNet_x0_25_textline_ori_infer", "Path of cls inference model.");
